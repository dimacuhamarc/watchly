...
const copy = {
  ...
  description:
    'Stop the endless scrolling. Find, track, and discover movies & shows effortlessly.',
  button: 'Get Started',
}

export default function CTA() {
  return (
    <TransitionProvider className="mx-auto flex h-1/2 flex-col gap-6 bg-gradient-to-br from-transparent via-slate-800 to-transparent py-24 text-slate-50">
