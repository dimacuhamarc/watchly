  ...
  return (
    <div className="w-full bg-slate-900 flex flex-row py-[82px] px-[90px] justify-center border-t border-t-slate-primary">
      <div className="flex flex-col w-[1014px]">
        <div className="flex md:flex-row flex-col md:px-[50px] md:justify-between">
          <FooterLinks />
          <div className="flex flex-col gap-2 justify-between">
            <Image src={"/assets/brand-light.svg"} alt="Brand" className="ml-auto mr-auto md:ml-auto md:mr-0 md:mb-0 mb-4" width={144*1.2} height={37*1.2} />
            <div className="flex flex-col gap-2 items-center md:items-end">
              <span className='hidden md:flex'>Have a feature request or a bug report?</span>
        ...
        <div className="flex md:flex-row flex-col md:gap-0 gap-4 justify-between text-slate-300">
